        ...
        <div className="space-y-10 p-4">
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              <code className="font-mono text-white">nums</code> and an integer{" "}
              <code className="font-mono text-white">target</code>, return
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1 text-gray-300">
              ...
              <li>
                <code className="font-mono">-10⁹ ≤ nums[i] ≤ 10⁹</code>
              </li>
              <li>
                <code className="font-mono">-10⁹ ≤ target ≤ 10⁹</code>
              </li>
